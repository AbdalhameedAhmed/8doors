...
export default function PatientOnBoarding () {
  ...
  const stepOne = [
    <StepOne key={0} nestedActiveForm={nestedActiveForm} changeActiveItem={changeActiveItem} activeItem={activeItem} changeNestedActiveForm={changeNestedActiveForm} initialInputValues={userInfo}/>,
    <EmailOTP key={1} nestedActiveForm={nestedActiveForm} changeNestedActiveForm={changeNestedActiveForm}/>,
    <CreatePassword key={2} changeActiveItem={changeActiveItem} activeItem={activeItem}/>
  ]
  ...
  return (
    ...
    <OnBoarding boardingList={boardingList} activeItem={activeItem} nestedActiveForm={nestedActiveForm} changeActiveItem={changeActiveItem} changeNestedActiveForm={changeNestedActiveForm}/>
    </div>
  )
}