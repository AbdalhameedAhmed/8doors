  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative">
        <input type={inputType} id={props.name} placeholder=" " className={classNames("block p-4 w-full text-gray-900 dark:text-white bg-transparent rounded-lg border-[1px] border-gray-300 appearance-none focus:border-[rgb(118,118,118)] dark:border-[#3D464F] hover:border-[rgb(118,118,118)] focus:outline-none focus:ring-0 peer", { "!border-red-500": error && errorActive })} {...props} />
