...
export default function PasswordInput({
  ...
  return (
    <div className="relative mb-6">
      ...
      {error && errorActive && errorAfterSubmit && <p className={`text-red-500 text-[0.75rem] top-full left-0 text-sm mt-2 ${errorStyle}`}>{error}</p>}
    </div>
